...
def test_inter(request):
    if request.method == 'GET' or request.method == 'POST':
        ...
        #     for ip in ip1.items:
        #         ips = ip.address
        return HttpResponse(json.dumps({'sharehaedURL':'https://mmbiz.qlogo.cn/mmbiz_png/YGE76YBu7064VpxGrEYzhfx2yLlwib2PgUQMQ6YkBaviawicFSpUpwfFZRP9jdMFWXJKhoRCck36CfY1YPYGqqknA/0?wx_fmt=png','Kefulist':'123456','Tipmsg':'欢迎大家','shareURL':'http://www.devops89.cn:81/share.html','version':'1.0.2','ip':'47.92.134.87','URL':'http://www.devops89.cn:56/yingjia.html','post':'7070'}))
