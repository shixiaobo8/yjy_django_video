     ...
     if request.method == 'GET':
         ...
         res1 = """
            ...
            <div class="test">
                ...
                <br/>没有安装请点击下面的按钮下载<br/>
                <center><a href="www.devops89.cn:56/apk/YinJiaPengHu.apk"><img src='http://www.devops89.cn:56/downloadBtn.png' alt='点击下载app'/></a></center>
                </div>
                <script>
                                function startAPP(){
...
def test_inter(request):
    if request.method == 'GET' or request.method == 'POST':
        ...
        #     for ip in ip1.items:
        #         ips = ip.address
        return HttpResponse(json.dumps({'sharehaedURL':'https://mmbiz.qlogo.cn/mmbiz_png/YGE76YBu7064VpxGrEYzhfx2yLlwib2PgUQMQ6YkBaviawicFSpUpwfFZRP9jdMFWXJKhoRCck36CfY1YPYGqqknA/0?wx_fmt=png','Kefulist':'123456','Tipmsg':'欢迎大家','shareURL':'http://www.devops89.cn:81/share.html','version':'1.0.3','ip':'47.92.134.87','URL':'http://www.devops89.cn:56/yingjia.html','post':'7070'}))
